...
#
#     def get_password_recovery_requests(self, status: str = "pending") -> List[Dict]:
#         """Get password recovery requests filtered by status"""
#         try:
#             query = """
#                 SELECT
#                     pr.request_id,
...
#
#             with self.connection.cursor(dictionary=True) as cursor:
#                 cursor.execute(query, (status.capitalize(),))
#                 return cursor.fetchall()
#         except Error as err:
#             logger.error(f"Error getting password recovery requests: {err}")
#             return []
#
#     def approve_password_recovery(self, request_id: int) -> bool:
...
#         except Error as err:
#             logger.error(f"Error approving password recovery request: {err}")
#             return False
#
#     def reject_password_recovery(self, request_id: int) -> bool:
...
#                 return cursor.rowcount > 0
#         except Error as err:
#             logger.error(f"Error rejecting password recovery request: {err}")
#             return False
#
...
#                 return cursor.rowcount > 0
#         except Error as err:
#             logger.error(f"Error resetting user password: {err}")
#             return False
#
#     def create_password_recovery_request(self, user_id: int, username: str, full_name: str) -> bool:
...
#                 return True
#         except Error as err:
#             logger.error(f"Error creating password recovery request: {err}")
#             return False
#
...
#         """Get count of past reservations for customer"""
#         try:
#             with self.connection.cursor() as cursor:
#                 cursor.execute("""
#                     SELECT COUNT(*)
...
#                 return cursor.fetchone()[0] or 0
#         except Error as err:
#             logger.error(f"Error getting customer past reservations: {err}")
#             return 0
#
#     def get_customer_reservations(self, user_id: int) -> List[Dict]:
#         """Get all reservations for customer with details"""
#         try:
#             with self.connection.cursor(dictionary=True) as cursor:
#                 cursor.execute("""
#                     SELECT
...
#                         CONCAT('$', booking_amount) AS amount
#                     FROM reservations
#                     WHERE user_id = %s
...
#                 return cursor.fetchall()
#         except Error as err:
#             logger.error(f"Error getting customer reservations: {err}")
#             return []
#
...
#             return None
#     #
#     # def get_staff_assigned_reservations(self, staff_id: str) -> List[Dict]:
#     #     """Get reservations assigned to specific staff member"""
#     #     try:
#     #         with self.connection.cursor(dictionary=True) as cursor:
#     #             cursor.execute("""
...
#     #                 WHERE r.assigned_staff = %s
#     #                 ORDER BY r.checkin_date DESC
#     #                 LIMIT 10
#     #             """, (staff_id,))
#     #             return cursor.fetchall()
#     #     except Error as err:
#     #         logger.error(f"Error getting staff reservations: {err}")
#     #         return []
#
...
#     #                     AVG(booking_amount) AS avg_booking
#     #                 FROM reservations
#     #                 WHERE assigned_staff = %s
#     #             """, (staff_id,))
#     #             return cursor.fetchone() or {}
#     #     except Error as err:
#     #         logger.error(f"Error getting staff performance: {err}")
#     #         return {}
#
...
#         try:
#             query = """
#                 SELECT r.reservation_id, r.guest_name,
#                        DATE_FORMAT(r.checkin_date, '%Y-%m-%d') AS checkin_date,
#                        DATE_FORMAT(r.checkout_date, '%Y-%m-%d') AS checkout_date,
#                        r.booking_amount, r.payment_status, r.fulfillment_status,
...
#                     (reservation_id, user_id, customer_id, guest_name,
#                      checkin_date, checkout_date, booking_amount,
#                      payment_status, fulfillment_status, assigned_staff)
...
#                         reservation_data["booking_amount"],
#                         reservation_data["payment_status"],
#                         reservation_data["fulfillment_status"],
#                         reservation_data.get("assigned_staff"),
#                     ),
#                 )
#                 return True
#         except Error as err:
...
#                 if 'assigned_staff' in updated_data:
#                     query += "assigned_staff = %s, "
#                     params.append(updated_data['assigned_staff'])
#
...
#             'get_password_recovery_requests'
#         ]
#
